...
import { addLocationData } from './api';
      ...
      <ThemeModeContext.Provider value={themeMode}>
        <ThemeProvider theme={theme}>
          ...
          <Router>
            <Switch>
              {
                routes.filter((r: AppRoute) => r.isExternal).map((route: AppRoute) => addRoute(route))
              }
              <Layout>
                {routes.filter((r: AppRoute) => !r.isExternal).map((route: AppRoute) =>
